...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"   >
      <div class="container">
        <div class="navbar-header">
          ...
          <div class="row" >
            <a class="navbar-brand" href="index.php" col-md-3>Bulldawg Bookstore</a>
    ...
    <div class="jumbotron" style="  background: url('https://news.uga.edu/wp-content/uploads/2021/03/arch_sun_nosign.jpg') no-repeat center center;background-size: cover;height:400px
;
  " >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto; color: white; background-color: gray; border-radius: 10px; padding: 10px;">Bulldawg Bookstore</h1>   
        <p style="text-align:center; margin:5% auto; color: white; background-color: gray; border-radius: 10px; padding: 10px;">Find your favorite books and order them online!</p>     
      </div>
    </div>
    <?php } ?>
